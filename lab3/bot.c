...
int main(int argc, char *argv[])
{
    ...
    while (1)
    {
        ...
        if(operation == 0) {
            ...
            printf("Primio sam poruku PROG_TCP.\n");
            ...
            printf("Primio sam poruku PROG_UDP.\n");
            char *serverPort = m->pairs[0].PORT;
            char *serverIP = m->pairs[0].IP;
